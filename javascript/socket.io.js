...
function url(uri, loc){
  ...
  // define href
  obj.href = obj.protocol + '://' + obj.host +':' + obj.port;
...
function Socket(uri, opts){
  ...
  this.port = (location.protocol == 'https:')? 443 : 80;
...
var SocketSentinel = function (socket, spareUri) {
    if (!socket) {
        return;
    }
...
var SocketUtils = {
    getConnectURI: function (host, roomId) {
        if (!host) {
            return '';
        }
